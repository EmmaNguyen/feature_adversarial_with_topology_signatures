...
# from torch_geometry_score.gs import geom_score
from torch_geometry_score.gs.geom_score import rlt, rlts, geom_score
...
for it in range(1000000):
    ...
    # import pdb; pdb.set_trace()
    reg = torch.mean(lam1 * metric_regularized(X, G_sample_reg) + lam2 * log(D_reg))
    ...
    E_loss = torch.mean(lam1 * metric_regularized(X, G_sample_reg) + lam2 * log(D_reg))
